...
// Commented out require() function in order for the fetch-example.js script to work in the browser.
...
fetch("https://www.googleapis.com/books/v1/volumes?q=isbn:0747532699")
	...
	.then((result) => {
			...
			// Displays the title of the book in the console.
			let title = result.items[0].volumeInfo.title;
			console.log("Title:\n\n" + title + "\n");
			
			// Displays the title of the book on the webpage.
			document.getElementById("title").innerHTML = "<h2>Title</h2><p>" + title + "</p>";
			
			// Displays the description of the book in the console.
			let description = result.items[0].volumeInfo.description;
			console.log("Description:\n\n" + description + "\n");
			
			// Displays the description of the book on the webpage.
